...
class PetAPI extends Client {
     ...
     */
    public async getPetById(id: string | number): Promise<AxiosResponse> {
        return this.getRequest(`/v2/pet/${id}`);
    }

    public async createUpdatePet(data: object): Promise<AxiosResponse> {
    ...
    public getPayloadData(id: any, category: any, name: any, photoUrls: any, tags: any, status: any, clearNull = false) {
